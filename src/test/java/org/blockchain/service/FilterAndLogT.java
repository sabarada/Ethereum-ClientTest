...
import org.blockchain.domain.dto.Filter;
import org.blockchain.domain.dto.Result;
import org.blockchain.domain.lottery.service.LotteryService;
...
public class FilterAndLogT extends GethClientT{
	...
	public void filterAndLog() throws InterruptedException
	{
    	...
    	// when [log]
    	EthInputVO<?, EthResultVOEvent> eth_getFilterChangesInput = new EthInputVO<>("eth_getTransactionReceipt", java.util.Arrays.asList(filterID), EthResultVOEvent.class);
    	Result[] results = send(eth_getFilterChangesInput, EthResultVOEvent.class).getResult();
//    	
//    	// then ()
    ...
    public void eth_getFilterChanges() throws IOException
    {
    	...
    	// when
    	EthInputVO<?, EthResultVOEvent> ethInputVO = new EthInputVO<>("eth_getFilterChanges", java.util.Arrays.asList(filterID), EthResultVOEvent.class);
    	
    	// then
    	assertThat(send(ethInputVO, EthResultVOEvent.class).getResult(), is(notNullValue()));
    }
